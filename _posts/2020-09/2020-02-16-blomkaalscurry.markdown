...
header:
  teaser: "assets/images/posts/henrik/blomkaalscurry/blomkaalscurry-header.jpg"
  overlay_image: "assets/images/posts/henrik/blomkaalscurry/blomkaalscurry-header.jpg"
  overlay_filter: 0.2
  actions:
  - label: Direkte til opskriften
    url: "/Blomkaalscurry/#opskrift"
gallery1:
- url: "assets/images/posts/henrik/blomkaalscurry/blomkaalscurry-header.jpg"
  image_path: "assets/images/posts/henrik/blomkaalscurry/blomkaalscurry-header.jpg"
  alt: Blomkaalscurry
...
Nu er det heldigvis sådan, at copyright til en opskrift ikke ligger i ingredienslisten (som jeg egentligt også har ændret en del på når jeg nu tænker over det) eller det generelle koncept, men i beskrivelsen af fremgangsmåden, så her følger min meget mere udførlige og  forhåbentligt bedre beskrivelse af, hvordan man laver en blomkålscurry med kikærter! :grin:
